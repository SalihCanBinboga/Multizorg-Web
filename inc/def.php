<?php
   ...
   /* if ($_SERVER['REQUEST_URI'] == '/prj/nbp/uyecincom'.'/inc/def.php') {
...
$mn_au='Eldem ÖZTÜRK, eldemozturk.com';
$mn_cp='Eldem ÖZTÜRK, eldemozturk.com';
$mn_gv='OPBXZHQ-Yj5tLEWYDSzpHaQQPW5vFXKC_V9ObpKJehw';
$mn_ds='Eldem ÖZTÜRK';
$mn_pb='SiToGa , sitoga.net , Eldem ÖZTÜRK, eldemozturk.com';
$rbts='all';
if ($_SERVER['REQUEST_URI']=='/ssy.php') {$rbts='noindex, follow';}
